        ...
        <div class="row p-4">
            <div class="col-lg-6 offset-lg-3">
                <div class="card text-right">
                    ...
                    <div class="card-body">
                        <div id="formulario">
                            <form action="CrearEvento.php" method="post" id="formularioEvento" class="needs-validation <?= ($noExitoso && isset($_POST["enviar"]) && $_POST["enviar"] === CINE) ? "was-validated":"" ?>" novalidate>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="evento" type="text" name="nombre" placeholder="Nombre del evento" pattern="<?=Regex::NOMBRE->value?>" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="lugar" type="text" name="lugar" placeholder="Lugar del evento" pattern="<?=Regex::NOMBRE->value?>" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="Tarifa" type="number" name="tarifa" placeholder="tarifa" min="0" max="???" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3 ">
                                    ...
                                    <input class="form-control" id="aforo" type="number" name="aforo" placeholder="Aforo máximo (0-???)" min="0" max="???" required>    
                                    <div class="invalid-feedback">
                                        El aforo máximo debe de estar entre 0 y ???
                                    </div>
                                </div>
